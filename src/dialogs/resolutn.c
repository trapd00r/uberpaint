...
/* this needs to be reworked to be more flexible/support more screenmodes */
/* this might require dropdown menus to be implemented, or perhaps a 
   multiselect box type of thing */
...
int resd_button_callback(JSUI_DIALOG * d, int object, int msg)
{
    ...
    case(13): /* 1280x854 */ resd_width = 1280;  resd_height = 854;   break;
    ...
    case(18): /* 8 bit */   /// resd_videobpp = 8;  break; //disabled
    case(19): /* 32 bit */  resd_videobpp = 32;  break;
...
JSUI_DIALOG resolution_dialog[] =
{
   /* (dialog proc)     (x)   (y)   (w)   (h)   
    ...
    {jsui_widget_frame, 0, 0, 355, 300, 0, 
    ...
    {jsui_widget_button, 185, 160, 150, 18, 0, 0, JSUI_B_STICKY|JSUI_B_RADIO, 2, "1280x854", NULL, (void *)resd_button_callback},

    /* 14 */
    {jsui_widget_3Dbox, 5, 10, 345, 180, 0, JSUI_F_NOFRAME, JSUI_T_LEFT, JSUI_3_LOWERED, " Resolution ", NULL, NULL},

    /* 15 */
    {jsui_widget_button,  15, 215, 150, 18, 0, 0, JSUI_B_STICKY|JSUI_B_RADIO|JSUI_B_ON, 3, "Window", NULL, (void *)resd_button_callback},
    {jsui_widget_button,  15, 235, 150, 18, 0, 0, JSUI_B_STICKY|JSUI_B_RADIO, 3, "Full Screen", NULL, (void *)resd_button_callback},
    {jsui_widget_3Dbox, 5, 200, 170, 65, 0, JSUI_F_NOFRAME, JSUI_T_LEFT, JSUI_3_LOWERED, " Display ", NULL, NULL},
    
    /* 18 */
    {jsui_widget_button, 190, 215, 150, 18, 0, JSUI_F_DISABLED, JSUI_B_STICKY|JSUI_B_RADIO, 4, "8 bpp", NULL, (void *)resd_button_callback},
    {jsui_widget_button, 190, 235, 150, 18, 0, 0, JSUI_B_STICKY|JSUI_B_RADIO|JSUI_B_ON, 4, "32 bbp", NULL, (void *)resd_button_callback},
    {jsui_widget_3Dbox,  180, 200, 170, 65, 0, JSUI_F_NOFRAME, JSUI_T_LEFT, JSUI_3_LOWERED, " Depth ", NULL, NULL},

    /* 21 */
    {jsui_widget_button, 200, 275, 150, 18, 0, 0, 0, 4, 
		STR_LK( STRINGS_OK ), NULL, (void *)resd_button_callback},
