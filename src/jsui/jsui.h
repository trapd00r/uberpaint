...
#define JSUI_MSG_USCROLL     19	  /* scroll wheel up */
#define JSUI_MSG_DSCROLL     20	  /* scroll wheel down */

#define JSUI_MSG_KEY         20   /* keyboard shortcut */
#define JSUI_MSG_CHAR        21   /* other keyboard input */
#define JSUI_MSG_UCHAR       22   /* unicode keyboard input */
#define JSUI_MSG_XCHAR       23   /* broadcast character to all objects */
#define JSUI_MSG_WANTFOCUS   24   /* does object want the input focus? */

#define JSUI_MSG_IDLE        25   /* update any background stuff */
#define JSUI_MSG_RADIO       26   /* clear radio buttons */
#define JSUI_MSG_TIMETICK    27   /* one tick of time has passed */

#define JSUI_MSG_TRIGGER_L   28   /* Trigger as if it was pressed with left */
#define JSUI_MSG_TRIGGER_R   29   /* Trigger as if it was pressed with right */

#define JSUI_MSG_USER       128  /* from here on are free... */
