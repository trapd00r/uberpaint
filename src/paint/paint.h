...
#define PAINT_MSG_MENUPOP		(JSUI_MSG_USER + 62)

	#define MENUPOP_MAIN		(0)

	#define MENUPOP_APP		(10)

	#define MENUPOP_FILE		(20)
	#define MENUPOP_FILE_FLIP	(21)
	#define MENUPOP_FILE_COLOR	(22)
	#define MENUPOP_FILE_SPARE	(23)

	#define MENUPOP_BRUSH		(30)
	#define MENUPOP_BRUSH_SIZE	(31)
	#define MENUPOP_BRUSH_FLIP	(32)
	#define MENUPOP_BRUSH_OUTLINE	(33)
	#define MENUPOP_BRUSH_ROTATE	(34)
	#define MENUPOP_BRUSH_COLOR	(35)
	#define MENUPOP_BRUSH_HANDLE	(36)

	#define MENUPOP_MODE		(40)

	#define MENUPOP_ANIM		(50)

	#define MENUPOP_EFFECTS			(60)
	#define MENUPOP_EFFECTS_STENCIL		(61)
	#define MENUPOP_EFFECTS_BACKGROUND	(62)

	#define MENUPOP_FONT		(70)
	#define MENUPOP_FONT_STYLE	(71)

	#define MENUPOP_PREFS		(81)
