...
)
{
    ...
    tool_callback_register(PAINT_MSG_PALETTEEDIT, CB_ONESHOT, tools_palette_edit );
    tool_callback_register('p', CB_ONESHOT, tools_palette_edit );
    ...
    tool_callback_register(SDLK_EXCLAIM, CB_ONESHOT, tools_mode_change);
    tool_callback_register(SDLK_AT, CB_ONESHOT, tools_mode_change);
    tool_callback_register(SDLK_HASH, CB_ONESHOT, tools_mode_change);
	/* SDLK_DOLLAR 37(%) CARET AMPERSAND ASTERISK */
